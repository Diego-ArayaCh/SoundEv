...
function fn_error(){
    var divMap = document.getElementById('map-ed');
...
function fn_ok(respuesta){
    ...
    var objConfigMarker1 = {
        position: new google.maps.LatLng(9.936821, -84.107701) , //Ruta del evento
        map: gMap,
        title: "Evento"
    };
   ...
   gMarker1.setIcon('../Eventos/music1.png')
    var objHTML = {
        content:'<div style = " padding: 5px; color: #BA882C;  background-color: #363636; border-radius: 20px; height: 150px; width: 150px"><h2>Estadio Nacional</h2> <h3>Evento<h3></div>'
   ...
   var gIW = new google.maps.InfoWindow(objHTML)
    ...
    var objConfigDS = {
        origin: gLatLng,
        destination: new google.maps.LatLng(9.936821, -84.107701), //Ruta del evento
