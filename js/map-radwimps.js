...
function fn_error(){
    var divMap = document.getElementById('map-radwimps');
...
function fn_ok(respuesta){
    ...
    var objConfigMarker1 = {
        position: new google.maps.LatLng(9.933189, -84.079345) , //Ruta del evento
        map: gMap,
        title: "Evento"
    };
    ...
    var objHTML = {
        content:'<div style = " padding: 5px; color: #BA882C;  background-color: #363636; border-radius: 20px; height: 150px; width: 150px"><h2>Melico Salazar</h2> <h3>Evento<h3></div>'
   ...
   var gIW = new google.maps.InfoWindow(objHTML)
    ...
    var objConfigDS = {
        origin: gLatLng,
        destination: new google.maps.LatLng(9.933189, -84.079345), //Ruta del evento
