...
function enviar() {
    ...
    document.getElementById('edad').textContent = 'Edad: ' + calcularEdad(fecha.value);
    ...
    "<h3 style= 'color: #9F9F9F;'>Su contacto ha sido guardado.</h3> "+
    " <p style= 'color: #fff; margin-bottom: 20px;'>Pronto será atendido/a por uno de nuestros agentes.</p>"+
    " </div> ";
